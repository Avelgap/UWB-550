...
function AccordionRow({
  ...
  return (
    <div>
      {/* Sticky header — sticks within its accordion container bounds */}
      <div
        style={{
          position: "sticky",
          top: stickyTop,
      ...
      >
        ...
        >
          <span style={{ fontSize: 14, fontWeight: 700, color: NAVY, letterSpacing: 0.14, lineHeight: "20px" }}>
            {label}
          </span>
      ...
      >
        {items.map((item) => (
          ...
          >
            <span style={{ fontSize: 12, fontWeight: 400, color: "#4a4a4a", letterSpacing: 0.12, lineHeight: "16px" }}>
              {item}
            </span>
          </button>
        ))}
...
export default function ShopAllPage() {
  ...
  return (
    ...
    >
      {/* ── STATUS BAR (55px) ── */}
      <div style={{ position: "absolute", top: 0, left: 0, width: 390, height: 55, background: "#fff", zIndex: 20 }}>
      ...
      {/* ── L2 TOP NAV (48px, top: 55) ── */}
      <div style={{ position: "absolute", top: 55, left: 0, width: 390, height: 48, background: "#fff", zIndex: 20, display: "flex", alignItems: "center", paddingLeft: 8, paddingRight: 8 }}>
        <button
          onClick={() => router.back()}
          style={{ width: 40, height: 40, background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", padding: 8 }}
        >
          <BackChevron />
        </button>
        <span style={{ fontSize: 16, fontWeight: 400, color: NAVY, flex: 1, textAlign: "center" }}>
          Shop All
        </span>
      ...
      {/* ── OVERLAY: search bar eases in on scroll-up (56px) ── */}
      <div
        style={{
          position: "absolute",
          top: 103,
      ...
      {/* ── SCROLLABLE CONTENT (top: 103, bottom: 85) ── */}
      <div
        ref={scrollRef}
      ...
      >
        {/* Sentinel: marks the top of the scroll area for IntersectionObserver */}
        <div ref={sentinelRef} style={{ height: 1 }} />

        {/* Inline search bar — scrolls away naturally on scroll-down */}
        <SearchBar />

        {/* Hero image */}
        <div style={{ width: "100%", height: 260, position: "relative", overflow: "hidden" }}>
          <Image
            src="/images/sport/shop_all_hero.png"
            alt="Shop All"
            fill
      ...
      >
        <div style={{ height: 51, width: 390, display: "flex", alignItems: "center", paddingTop: 4, paddingBottom: 4 }}>
          ...
          <button style={{ width: 80, height: 43, background: "none", border: "none", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 4 }}>
            <ShirtIcon />
